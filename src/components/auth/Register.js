...
class Login extends Component {
    ...
    onSubmit = e => {
        ...
        firebase.createUser({email, password}).catch(err => notifyAction("this user is ALREDY REGISTERED", "error"));
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <input value="Register" type="submit" className="btn btn-primary btn-block" />
                            </form>
                        </div>
                    </div>
                </div>
